...
var check_window = function(x) {
   ...
   return x.replace(x, function(){ return  x_;});
...
var action_1 = function (x,y,z) {
  ...
  return x.replace(y, function(){ return  z_;});
}
...
var concat_within_brackets = function(x,y) {
      ...
      return x.replace(y, function(){ return y_;});
}
...
function JSFuck_Object() {
  ...
  try{
      if (str.search(/[^()\[\]+!]/) != -1) 
          throw {name: "Input error", message: "Data contains extra characters. Should be only ()[]+!"}
